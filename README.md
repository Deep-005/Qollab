...
POST	/api/login/	JWT login	No
POST	/api/refresh/	Refresh JWT token	No
POST	/api/jobs/	Create job posting	Yes
GET	/api/jobs/	List all jobs	Yes
GET	/api/jobs/{id}/	Get job details	Yes
GET	/api/jobs/{id}/match/	Get ranked candidates	Yes
POST	/api/resumes/batch/	Batch upload resumes	Yes
GET	/api/resumes/count/	Get resume count	Yes
DELETE	/api/resumes/clear-all/	Delete all resumes	Yes
DELETE	/api/resumes/{id}/	Delete single resume	Yes
